...
movies = [
    # {
    #     'id': '11211',
    #     'thumbnail': 'https://img5.doubanio.com/view/movie_poster_cover/lpst/public/p2410576676.jpg',
    #     'title': u'太空旅客',
    #     'rating': u'6.9',
    #     'comment_count': 12000,
    #     'authors': u'詹妮弗·劳伦斯 / 克里斯·普拉特 / 麦克·辛'
    # },
    {
        'id': '34532',
        'title': u'降临',
        'thumbnail': u'https://img3.doubanio.com/view/movie_poster_cover/mpst/public/p2411622421.jpg',
        'rating': u'7.6',
        'comment_count': 39450,
        'authors': u'艾米·亚当斯 / 杰瑞米·雷纳 / 福里斯特·惠特克'
    },
    {
        'id': '394558',
        'title': u'情圣',
    ...
    #     'id': '9384089',
    #     'title': u'星球大战外传：侠盗一号',
    #     'thumbnail': u'https://img5.doubanio.com/view/movie_poster_cover/mpst/public/p2403049086.jpg',
    #     'rating': u'7.4',
    #     'comment_count': 4555,
    #     'authors': u'菲丽希缇·琼斯 / 迭戈·鲁纳 / 甄子丹'
    # },
    {
        'id': '26921827',
        'title': u'大卫贝肯之倒霉特工熊',
    ...
    },
    {
        'id': '26287884',
        'title': u'魔弦传说',
        'thumbnail': u'https://img5.doubanio.com/view/movie_poster_cover/mpst/public/p2411608656.jpg',
        'rating': u'7.5',
        'comment_count': 33060,
...
tvs = [
    ...
    #     'id': '26685451',
    #     'title': u'流浪猫鲍勃',
    #     'thumbnail': u'https://img5.doubanio.com/view/movie_poster_cover/lpst/public/p2360939756.jpg',
    #     'rating': u'8.2',
    #     'comment_count': 345,
